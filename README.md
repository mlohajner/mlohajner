...
## 🛠️ The Philosophy: GNU/Linux Thinking & The Bash Glue

My development approach is fundamentally rooted in **GNU/Linux/UNIX thinking** and the strict **KISS (Keep It Simple, Stupid)** principle. I believe software should consist of simple, specialized tools that do one thing and do it exceptionally well. 
...
### 📐 [gtk-ruler](https://github.com/mlohajner/gtk-ruler) | *C / GTK*
...
### 🖼️ [CSplash](https://github.com/mlohajner/CSplash) | *Shell / Chafa*
...
### 📡 [WiFi-spectrum](https://github.com/mlohajner/wifi-spectrum) | *Python 3*
...
### 💾 [RRALLOC](https://github.com/mlohajner/RRALLOC) | *C / Linux Kernel 7.1.3*
